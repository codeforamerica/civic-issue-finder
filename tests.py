...
class AppTestCase(TestCase):
    ...
    def response_content(self, url, request):
        ...
        elif url.geturl() == 'http://codeforamerica.org/api/organizations/Code-for-America/issues':
        ...
        elif url.geturl() == 'http://codeforamerica.org/api/issues/labels/help%20wanted,enhancement':
        ...
        elif url.geturl() == 'http://codeforamerica.org/api/issues':
        ...
        elif url.geturl() == 'http://codeforamerica.org/api/issues?per_page=2':
